...
this.addInputEventListeners();
  ...
  addInputEventListeners(listElement) {
    ...
    inputElements.forEach((input) => {
        ...
        const updateInput = () => {
            ...
            console.log("les ememels:",listElement);
  ...
  updateDropdowns(uniqueItems, type) {
    ...
    if (listElement) {
      ...
      listElement.innerHTML = uniqueItems[type] ? uniqueItems[type].map((item) =>
       `<li>${this.normalizeItem(item)}</li>`)
            .join("")
        : "";

    }
    this.addInputEventListeners(listElement);
